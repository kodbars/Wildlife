...
public class Eagle extends Predator{
    ...
    private double weight = 6d;
    private int animalMax = 5;
    private int movingMax = 3;
    private double animalSatietyKg = 1d;
    private double eatenKg;
    private volatile int size;
    private final String ICON = "eagle.png"; //орел
    ...
    @Override
    public double getAnimalSatietyKg() {return animalSatietyKg;}
    @Override
