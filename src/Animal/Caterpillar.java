...
public class Caterpillar extends Herbivores{
    ...
    private double weight = 0.01d;
    private int animalMax = 150;
    private int movingMax = 0;
    private double animalSatietyKg = 0d;
    private volatile int size;
    private double eatenKg;
    private final String ICON = "caterpillar.png"; //гусеница
